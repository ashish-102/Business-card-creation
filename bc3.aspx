<%@ Page Title="Simplecard3" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="bc3.aspx.cs" Inherits="online_business_card.bc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <center>
        <img width="60%" src="card/bebc3.png" class="img-thumbnail border-dark" />
    </center>
    <br />
    <br />
